...
function ProductItem({ isInStock, img, title, price, subPriceContent, maxRating, rating, ratingComponent, className }) {
  return (
    <div className={cx(s.goods, className, { [s.goodsNone]: !isInStock })}>
